        ...
        .use {
          case (a, b, c) =>
            ...
            ContractDaoConnected[IO].create(mockContract) >>
              ContractDaoConnected[IO].get(1) &>
              ContractDaoConnected[IO].getByConfigEntry(mockConfigEntry) &>
              ContractDaoConnected[IO].getByConfigEntry(mockConfigEntry.copy(primaryExch = None))
        }
        .unsafeRunSync() should ===((mockContract, (mockContract, None)))
    }
  }
}
...
object ContractDaoSpec {
  ...
  val mockContract: Contract = new Contract(
    ...
    deltaNeutralContract = Some(DeltaNeutralContract(contId = 0, delta = 0d, price = 1d)),
