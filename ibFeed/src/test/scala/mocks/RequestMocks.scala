...
trait RequestMocks {
  ...
  lazy val mockContractReq: RequestContract = RequestContract(mockContractEntry)

  lazy val mockDataReqHist: RequestData = RequestData(
    requestType = RequestType.Historic,
    size        = BarSize.Day1,
    contId      = 0,
  ...
  lazy val mockContractEntry: ContractEntry = ContractEntry(
  ...
  lazy val mockContract: Contract = new Contract(
    contId = 0,
